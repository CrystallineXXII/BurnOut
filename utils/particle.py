...
class Particle(pg.sprite.Sprite):
    def __init__(self, pos: Vector2, i: int, color = None):
        ...
        self.explosion_color = ["#f9f900", "#ff9d00", "#ff6a00"][randint(0, 2)] if color == None else color[randint(0, len(color) - 1)]
    ...
    def update(self, screen, deltatime, *, campos):
        ...
        pg.draw.circle(screen, self.explosion_color, self.pos - campos, radius)
