...
if True:
 ...
 def draw_polygon(pos,n,radius,angle = 0):
    ...
    pos + radialVec.rotate(stepAngle * i))
 ...
 class Player: 
     ...
     def update(self,deltatime): 
         ...
         pg.draw.polygon(screen,'red',draw_polygon(self.pos+Vector2(15,0).rotate(-ang),3,5,-ang))
  
         pg.draw.arc(screen,"#0487df",pg.Rect(self.pos.x - 15,self.pos.y - 15,30,30),radians(ang+40),radians(ang-40)) 
